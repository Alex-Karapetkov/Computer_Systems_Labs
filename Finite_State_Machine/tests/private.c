...
START_TEST (UNIT_one_proc_valid_events_state_only)
{
  fsm_t *process = process_init ();
  assert (process != NULL);

  printf ("\n======================================\n");
  printf ("UNIT TEST: one_proc_valid_events_state_only\n");
...
START_TEST (UNIT_one_proc_invalid_events_state_only)
{
  fsm_t *process = process_init ();
  assert (process != NULL);

  printf ("\n======================================\n");
  printf ("UNIT TEST: one_proc_invalid_events_state_only\n");
...
void private_tests (Suite *s)
{
  ...
  tcase_add_test (tc_private, UNIT_one_proc_valid_events_state_only);
  tcase_add_test (tc_private, UNIT_one_proc_invalid_events_state_only);
