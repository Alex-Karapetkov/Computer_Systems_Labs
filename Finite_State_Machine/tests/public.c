...
START_TEST (UNIT_admit_and_stop)
{
...
START_TEST (UNIT_one_proc_linear_state_only)
{
  fsm_t *fsm = process_init ();
  assert (fsm != NULL);
...
void public_tests (Suite *s)
{
  ...
  tcase_add_test (tc_public, UNIT_admit_and_stop);
  tcase_add_test (tc_public, UNIT_one_proc_linear_state_only);
