...
START_TEST (UNIT_split_string)
{
  printf ("\n======================================\n");
  printf ("UNIT_split_string\n");
...
void public_tests (Suite *s)
{
  ...
  tcase_add_test (tc_public, UNIT_split_string);
  tcase_add_test (tc_public, UNIT_cksum);
